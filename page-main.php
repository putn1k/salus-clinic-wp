  ...
  <div class="container">
    ...
    <ul class="list-reset advantages__list">
      <li class="advantages__item">
        <span class="advantages__lead-text">Современное оборудование</span>
        <span>При помощи японского аппратата УЗИ Экспертного класса получаем четкое трехмерное изображение, на котором видим, все органы и системы организма. Благодаря этому можем точно провести диагностику, поставить диагноз и назначить правильное, эффективное лечение. Используем одноразовые инструменты, что гарантирует чистоту осмотра.</span>
      </li>
      <li class="advantages__item">
        <span class="advantages__lead-text">Профессиональный персонал</span>
        <span>В нашем Мед.центре работают лучшие врачи во всех направлениях. Огромный опыт, многолетний стаж (от 10 до 30 лет) в ведущих больницах нашего города. Наши доктора ставят точные диагнозы благодаря постоянному повышению квалификации, а также несут ответственность за результат лечения, поэтому в качестве заинтересованы обе стороны, а не только пациент.</span>
      </li>
      <li class="advantages__item">
        <span class="advantages__lead-text">Индивидуальный подход к каждому пациенту</span>
        <span>Выбирая МЦ “Salus”, получаешь внимательность, отзывчивость и поддержку от специалистов, которые не только сами знают, как помочь в конкретной ситуации, но и правильно настраивают тебя на выздоровление. Гарантированно получишь детальный разбор своей проблемы. Доктору интересен каждый случай, и что самое главное — у него есть время на индивидуальную работу с пациентами. Записаться в МЦ “Salus” можно онлайн на любое удобное время. Если необходимо попасть к конкретному врачу, то нужно просто позвонить <?=get_phone(CONTACT_PHONES[0]['item']); ?>.</span>
      </li>
      <li class="advantages__item">
        <span class="advantages__lead-text">Комфорт и удобство</span>
        <span>Для вашего удобства все врачи работают не только по будням, но и по субботам. У нас удобные подъездные пути, большая парковка. Мы ценим ваше время, поэтому предлагаем воспользоваться нашими услугами в комплексе. За один визит в клинику Вы можете проконсультироваться у специалистов, сдать анализы, пройти дополнительные обследования и процедуры. В клинике проводятся все виды УЗИ, можно сдать более 2500 видов лабораторных анализов, в том числе и в субботу!</span>
      </li>
    </ul>
    <!-- <ul class="list-reset advantages__list">
      <li class="advantages__item">
